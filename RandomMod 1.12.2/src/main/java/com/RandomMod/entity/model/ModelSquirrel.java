...
public class ModelSquirrel extends ModelBase {
    ...
    public ModelSquirrel() {
        ...
        this.armTopRight = new ModelRenderer(this, 37, 0);
        this.armTopRight.setRotationPoint(1.0F, 18.7F, -1.9F);
        this.armTopRight.addBox(0.0F, 0.0F, 0.0F, 1, 2, 3, 0.0F);
        this.setRotateAngle(armTopRight, 0.12217304763960307F, 0.0F, 0.0F);
        ...
        this.armTopLeft = new ModelRenderer(this, 28, 0);
        this.armTopLeft.setRotationPoint(-3.3F, 18.7F, -2.0F);
        this.armTopLeft.addBox(0.0F, 0.0F, 0.0F, 1, 2, 3, 0.0F);
        this.setRotateAngle(armTopLeft, 0.12217304763960307F, 0.0F, 0.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
        this.armTopRight.render(f5);
        this.tailBottom.render(f5);
        this.tailTop.render(f5);
        this.armTopLeft.render(f5);
        this.head.render(f5);
        this.body.render(f5);
